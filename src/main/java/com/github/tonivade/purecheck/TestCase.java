...
public class TestCase<E, T> {
  ...
  /**
   * Validation to apply to the result generated by operation. It can be either a validator for a Throwable, to
   * validate the cases that we expect operation fail, and or a validation when the operation runs without errors.
   */
